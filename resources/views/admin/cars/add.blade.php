...
@section("content")
{!! Form::open(["method" => "POST", 'enctype' => 'multipart/form-data', 'action' => "AdminCarsController@store", "class" => "car-add-form"]) !!}
<div class="container-fluid">
    ...
    <div class="tab-content">
        <div id="section_ge" class="tab-pane fade in active tab-pane-holder">
            @include("admin/partials/car-form-lang", ["lang" => "ge"])
        </div>
        <div id="section_en" class="tab-pane fade">
            @include("admin/partials/car-form-lang", ["lang" => "en"])
        </div>
        <div id="section_ru" class="tab-pane fade">
            @include("admin/partials/car-form-lang", ["lang" => "ru"])
        </div>
    </div>
    @if(isset($cat))
    ...
    <span class="btn btn-primary btn-file">
        ...
        &nbsp;Browse <input type='file' id="inputFile" name="img" />
    </span>
    </div>
    <div class="col-lg-12">
