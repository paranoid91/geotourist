...
@section("content")
    {!! Form::open(["method" => "POST", 'enctype' => 'multipart/form-data', 'action' => "AdminEventsController@addSliderImg"]) !!}
    @if(session('msg'))
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="btn-group tour-btn-holder">
                            <a href="#" type="button" class="btn btn-danger tour-delete-btn" data-remove-pic-img="{{action('AdminEventsController@removeSliderImg', ['id' => $pic->id]) }}">
...
@section("script")
    <script>
        $(document).on("click", "a[data-remove-pic-img]", function(e) {
            var delLink = $(this).attr("data-remove-pic-img");
            bootbox.confirm({
