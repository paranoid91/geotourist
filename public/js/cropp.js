$(document).ready(function(){
    if($("#imagePick").length > 0){
        $("#imagePick").on("click",function(){
            $("canvas").show();
            $("div.zoom-bar").show();
        });
        ...
        var imageCropper = {
            ...
            init: function(tmppath) {
                this.image.src = tmppath;
            ...
            showCropedImage: function() {
                ...
                temp_canvas.height = this.windowHeight;
                ...
                //var output = vData.replace(/^data:image\/(png|jpg|jpeg|gif);base64,/, "");
                $("input.hidden-list-img").val(vData);
            },
            /**
